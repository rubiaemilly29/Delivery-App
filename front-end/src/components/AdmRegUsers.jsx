...
import { newAdm, deleteUser } from '../services/user';
import ErrorRegister from './ErrorRegister';
import TableUsers from './TableUsers';

function AdmRegUsers() {
  ...
  const regAdm = async (e) => {
    e.preventDefault();
    const create = await newAdm({ name, email, password, role }, hasToken);
    getUsers();
    return create;
  };
